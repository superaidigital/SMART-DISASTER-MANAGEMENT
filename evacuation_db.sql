...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2025 at 09:19 AM
...
CREATE TABLE `distributions` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `recipient_type` enum('evacuee','general') DEFAULT 'evacuee',
  `recipient_group` varchar(255) DEFAULT NULL,
  `proxy_receiver` varchar(255) DEFAULT NULL,
...
INSERT INTO `distributions` (`id`, `evacuee_id`, `item_id`, `quantity`, `created_at`, `recipient_type`, `recipient_group`, `proxy_receiver`, `note`, `created_by`) VALUES
(1, 1, 13, 1, '2025-12-27 16:04:20', 'evacuee', NULL, NULL, '', 2),
(2, 1, 14, 1, '2025-12-27 16:04:20', 'evacuee', NULL, NULL, '', 2),
(3, 1, 13, 1, '2025-12-27 16:08:17', 'evacuee', NULL, NULL, '', 2);
...
CREATE TABLE `evacuees` (
  ...
  `stay_type` enum('in_center','out_center') DEFAULT 'in_center',
  ...
  `vulnerable_detail` varchar(255) DEFAULT NULL,
  ...
  `id_card_moo` varchar(10) DEFAULT NULL,
  `id_card_subdistrict` varchar(100) DEFAULT NULL,
  `id_card_district` varchar(100) DEFAULT NULL,
  `id_card_province` varchar(100) DEFAULT NULL,
  `id_card_zipcode` varchar(10) DEFAULT NULL,
  `current_no` varchar(20) DEFAULT NULL,
  `current_moo` varchar(10) DEFAULT NULL,
  ...
  `id_type` enum('thai_id','passport','other','none') DEFAULT 'thai_id',
  ...
  `family_code` varchar(50) DEFAULT NULL COMMENT 'รหัสกลุ่มครอบครัว',
  `is_family_head` tinyint(1) DEFAULT 0,
  `vulnerable_type` text DEFAULT NULL COMMENT 'เก็บข้อมูลแบบ comma-separated',
  `created_by` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `evacuees` (`id`, `incident_id`, `shelter_id`, `stay_type`, `stay_detail`, `id_card`, `id_card_address`, `current_address`, `address_card`, `prefix`, `first_name`, `last_name`, `phone`, `address`, `health_status`, `needs`, `gender`, `age`, `health_condition`, `vulnerable_detail`, `registered_by`, `check_in_date`, `check_out_date`, `updated_at`, `created_at`, `triage_level`, `medical_condition`, `drug_allergy`, `last_medical_check`, `id_card_no`, `id_card_moo`, `id_card_subdistrict`, `id_card_district`, `id_card_province`, `id_card_zipcode`, `current_no`, `current_moo`, `current_subdistrict`, `current_district`, `current_province`, `current_zipcode`, `id_type`, `birth_date`, `religion`, `occupation`, `skills`, `dietary_restriction`, `emergency_contact_name`, `emergency_contact_phone`, `family_code`, `is_family_head`, `vulnerable_type`, `created_by`) VALUES
(1, 1, 1, 'in_center', '', 'LOST-251228-2', NULL, NULL, '', 'นาย', 'สมศักดิ์', 'รักชาติ', '081-111-2222', NULL, 'Normal', NULL, 'male', 31, 'ความดันโลหิตสูง', '', 2, '2025-12-22 14:12:37', NULL, '2025-12-28 01:09:27', '2025-12-22 14:12:37', 'green', '', '', NULL, '', '', '', '', '', '', '', '', '', '', '', '', 'none', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 0, '', NULL),
(2, 1, 1, '', NULL, '1330000333444', NULL, NULL, NULL, 'นาง', 'สมศรี', 'มีสุข', '089-333-4444', NULL, 'Normal', NULL, 'female', 42, '-', NULL, 2, '2025-12-22 14:12:37', NULL, NULL, '2025-12-22 14:12:37', 'green', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'thai_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(3, 1, 1, '', NULL, '1330000555666', NULL, NULL, NULL, 'ด.ช.', 'เก่ง', 'รักชาติ', NULL, NULL, 'Normal', NULL, 'male', 10, 'แพ้อาหารทะเล', NULL, 2, '2025-12-22 14:12:37', NULL, NULL, '2025-12-22 14:12:37', 'green', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'thai_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(4, 1, 2, 'out_center', 'บ้านญาติ', '1330000111222', NULL, NULL, '', 'นาย', 'วิชัย', 'ใจดี', '090-555-6666', NULL, 'Normal', NULL, 'male', 31, 'เบาหวาน, เดินไม่สะดวก', '', 1, '2025-12-22 14:12:37', NULL, '2025-12-28 14:09:47', '2025-12-22 14:12:37', 'green', '', '', NULL, '119', '1', 'พยุห์', 'พยุห์', 'ศรีสะเกษ', '33230', '119', '1', 'พยุห์', 'พยุห์', 'ศรีสะเกษ', '33230', 'passport', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 0, '', NULL),
(5, 3, NULL, 'out_center', 'บ้านญาติ', '1332000000946', NULL, NULL, '', 'นาย', 'วิชัย', 'ใจดี', '090-555-6666', NULL, 'Normal', NULL, 'male', 60, '', '', 1, '2025-12-22 16:15:33', NULL, '2025-12-28 14:19:33', '2025-12-22 16:15:33', 'yellow', 'หอบ', 'พารา', NULL, '119', '1', 'พยุห์', 'พยุห์', 'ศรีสะเกษ', '33230', '119', '1', 'พยุห์', 'พยุห์', 'ศรีสะเกษ', '33230', 'thai_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 0, 'elderly', NULL),
(6, 1, 1, 'in_center', '', '', NULL, NULL, NULL, 'นาย', '', '', '', NULL, 'Normal', NULL, 'male', 0, NULL, '', 3, '2025-12-28 14:42:17', NULL, '2025-12-28 14:42:30', '2025-12-28 14:42:17', 'green', '', '', NULL, '', '', '', '', '', '', '', '', '', '', '', '', 'thai_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 0, '', NULL),
(7, 1, 1, 'in_center', '', '1330000111222', NULL, NULL, NULL, 'นาย', '', '', '', NULL, 'Normal', NULL, 'male', 0, NULL, '', 3, '2025-12-28 15:01:08', NULL, '2025-12-28 15:02:07', '2025-12-28 15:01:08', 'green', '', '', NULL, '', '', '', '', '', '', '', '', '', '', '', '', 'thai_id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 0, '', NULL);
...
(13, 1, 'น้ำดื่ม (แพ็ค)', 398, 'แพ็ค', '2025-12-27 14:48:01', 'น้ำดื่ม'),
(14, 1, 'บะหมี่', 199, 'กล่อง', '2025-12-26 03:42:23', 'อาหาร');
...
(14, 13, 'out', 100, 3, 'แจกส่วนกลาง: ครัวกลาง (ผู้เบิก: ปฐวีกานต์)', '2025-12-27 21:48:01');
...
(2, 1, 6, 100, 'high', 'pending', '', '2025-12-27 16:00:13', '2025-12-27 16:00:13');
...
(94, 1, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 14:26:13'),
(95, 1, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 14:26:39'),
(96, 1, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 14:33:54'),
(97, 3, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 14:44:59'),
(98, 1, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 15:51:51'),
(99, 1, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 15:54:20'),
(100, 2, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 15:54:38'),
(101, 2, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 17:25:35'),
(102, 1, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-27 18:10:10'),
(103, 3, 'Login', 'เข้าสู่ระบบสำเร็จ', '::1', '2025-12-28 07:31:25');
