...
/**
 * evacuee_form.php
 * ฟอร์มลงทะเบียนและแก้ไขข้อมูลผู้ประสบภัย (v5.1.10 Final Polish)
 * พัฒนาโดย: ผู้ช่วยพัฒนาเว็บ PHP
 * สถานะ: เสถียร, รองรับ Mobile Camera, AJAX Family Sync, และ Thai Datepicker
 */
...
<div class="container-fluid py-2 container-intel">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h4 class="fw-bold text-dark mb-0"><i class="fas fa-user-shield text-primary me-2"></i><?php echo $mode == 'edit' ? 'แก้ไขข้อมูล: '.htmlspecialchars($data['fname']) : 'ลงทะเบียนผู้ประสบภัย (v5.1.10)'; ?></h4>
                    ...
                    <div class="col-lg-7 border-end pe-lg-4">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-auto text-center">
                                <div class="position-relative" onclick="$('#cameraModal').modal('show')">
                                    <img id="photo-output" src="<?php echo $data['photo_base64'] ?: 'https://cdn-icons-png.flaticon.com/512/149/149071.png'; ?>">
                                    <div class="extra-small fw-bold text-muted mt-1"><i class="fas fa-camera me-1"></i>คลิกถ่ายภาพ</div>
                                </div>
                            </div>
                            <div class="col">
                        ...
                        <div class="row g-2 mb-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label text-primary fw-bold">วันเกิด (พ.ศ.) <span class="required-mark">*</span></label>
                                <div class="input-group">
                                    <input type="text" id="birth_date_display" class="form-control fw-bold border-primary" placeholder="วว/ดด/พศ" readonly style="background:#fff;cursor:pointer;" required />
...
function startCamera() {
    ...
    }).catch(e => Swal.fire('Error', 'เข้าถึงกล้องไม่ได้', 'error'));
}
...
$('#cameraModal').on('shown.bs.modal', startCamera).on('hidden.bs.modal', function() {
    if(stream) stream.getTracks().forEach(t => t.stop());
});
